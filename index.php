       ...
       <form class="space-y-6" action="#">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input datepicker type="text" class="bg-white border  text-gray-900 sm:text-sm rounded-lg  block w-full pl-10 px-4 py-2.5 datepicker-input" placeholder="Select date">
              </div>
        </div>

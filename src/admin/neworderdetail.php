...
try {
    ...
    $mail->Username   = 'info@ezzeemiles.com';                     //SMTP username
    $mail->Password   = 'Admin!@#2310';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('info@ezzeemiles.com', "Your Booking has been $orderstatus");
    ...
    $mail->Body    = "Your Booking id: $purchaseid <br> has been $orderstatus";
    $mail->AltBody = "Your Booking id: $purchaseid <br> has been $orderstatus";

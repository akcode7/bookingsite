            ...
            >
              <label class="block text-sm">
                ...
                <div class="relative">
                  ...
                  />
                  <button
                    class="absolute inset-y-0 px-4 text-sm font-medium leading-5 text-white transition-colors duration-150 theme_color border border-transparent rounded-l-md active:theme_color hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                  >
                    Click
                  </button>
                </div>
              ...
              <label class="block mt-4 text-sm">
                ...
                >
                  ...
                  />
                  <button
                    class="absolute inset-y-0 right-0 px-4 text-sm font-medium leading-5 text-white transition-colors duration-150 theme_color border border-transparent rounded-r-md active:theme_color hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
                  >
                    Click
                  </button>
                </div>

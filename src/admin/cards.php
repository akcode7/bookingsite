    ...
    <div
      ...
      <aside
        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <div class="px-6 my-6">
            <button class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 theme_color border border-transparent rounded-lg active:theme_color hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
              Create account
              <span class="ml-2" aria-hidden="true">+</span>
            </button>
          </div>
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2">
              ...
              <div class="min-w-0 p-4 text-white theme_color rounded-lg shadow-xs">

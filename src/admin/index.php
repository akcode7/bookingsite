  ...
  <body>
    <div
      ...
      <aside
        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">
          <a href="#">
            <img src="public/logo/LRE-04.png" alt="" class="w-32 pl-5">
          </a>
          <ul class="mt-6">
            <li class="relative px-6 py-3">
              <span class="absolute inset-y-0 left-0 w-1 theme_color rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                ...
                <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
                  <nav aria-label="Table navigation">
                    <ul class="inline-flex items-center">
                      ...
                      <li>
                        <button class="px-3 py-1 text-white transition-colors duration-150 theme_color border border-r-0 border-purple-600 rounded-md focus:outline-none focus:shadow-outline-purple">
                          3
                        </button>
                      </li>
                      <li>

...
try {
    ...
    //Recipients
    $mail->setFrom('info@ezzeemiles.com', 'Your Booking has been cancelled');
    ...
    $mail->Body    = "Your Booking id: $purchaseid <br> has been canceled";
    $mail->AltBody = "Your Booking id: $purchaseid <br> has been canceled";
